...
<template>
  <div class="bg-[#ffffff] dark:bg-gray-800  min-h-screen py-[60px]">
    ...
    <div class="flex flex-row items-center justify-center gap-3 mt-[80px]">
      ...
      <h1 class="text-[18px] sm:text-[22px] font-serif font-bold dark:text-white ">魏无羡-网盘资源搜索</h1>
    </div>
    ...
    <div class="p-4">
      ...
      <p class="text-center text-[8px] sm:text-[12px] text-slate-400">
        ...
        <a class="text-blue-500 underline" href="mailto:k2091k@qq.com" title="点击留言"> 留言 </a> 告知删除。
